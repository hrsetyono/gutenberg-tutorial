...
const { RichText, MediaUpload, InspectorControls, PanelColorSettings } = editor;
const { Button, TextControl, ToggleControl, PanelBody } = components;
...
blocks.registerBlockType( 'my/tut-04', {
        ...
        ( atts.hasImage &&
          el( 'figure', {},
            el( MediaUpload, { allowedTypes: 'image', value: atts.mediaID,
              ...
              render: ( obj ) => {
                let className = atts.mediaURL	? 'button button--transparent' : 'button';
                let buttonContent = atts.mediaURL ?
  ...
  save: function( props ) {
    ...
    return el( 'div', { style: {
      ...
      ( atts.mediaURL && atts.hasImage ) && el( 'figure', {}, el( 'img', { src: atts.mediaURL } ) ),
